...
export const TransactionHistoryHeader = styled.header`
  width: 100%;
  height: 20px;
  margin-top: 40px;
  padding: 25px 0px;
...
export const IdHeader = styled(ColumnHeader)`
  width: 45%;
...
export const EmailHeader = styled(ColumnHeader)`
  width: 20%;
...
export const Id = styled(ColumnElement)`
  width: 45%;
...
export const Email = styled(ColumnElement)`
  width: 20%;
